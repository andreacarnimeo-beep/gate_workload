...
## Patch v1.7+ (v1.9)
- Periodo: supporto selezione **1 solo giorno** (start=end) e dataset mono-giorno.
- Auto-assegnazione report **Prelievi → Righe** cercando la riga `(*) Numero di Operazioni Prelievi` (keyword `preliev`).
